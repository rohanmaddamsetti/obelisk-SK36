...
The total population size $N(t) = x_1(t) + x_2(t)$.  
...
The growth and mutation dynamics are combined into a matrix $\mathbf{A}$:
...
and examine how $t^*$ changes as we change Obelisk copy number $N$ and Obelisk capacity $N^*$ (which is a measure of cellular burden/fitness copy of the Obelisk population at copy number $N$).
...
manifest_format = "2.0"
project_hash = "f31be81e5af582f6f15f2b905383b22f88aaee42"
